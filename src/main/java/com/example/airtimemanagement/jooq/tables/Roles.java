...
public class Roles extends TableImpl<RolesRecord> {
    ...
    /**
     * The reference instance of <code>airtime_manager.roles</code>
     */
    ...
    /**
     * Create an aliased <code>airtime_manager.roles</code> table reference
     */
    ...
    /**
     * Create a <code>airtime_manager.roles</code> table reference
     */
    public Roles() {
    ...
    public List<UniqueKey<RolesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_ROLES_NAME);
    }
