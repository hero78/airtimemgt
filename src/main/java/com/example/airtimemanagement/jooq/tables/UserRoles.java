...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    /**
     * The reference instance of <code>airtime_manager.user_roles</code>
     */
    ...
    /**
     * Create an aliased <code>airtime_manager.user_roles</code> table reference
     */
    ...
    /**
     * Create a <code>airtime_manager.user_roles</code> table reference
     */
    public UserRoles() {
    ...
    public List<ForeignKey<UserRolesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FK_USER_ROLES_USER, Keys.FK_USER_ROLES_ROLE);
    }
    ...
    /**
     * Get the implicit join path to the <code>airtime_manager.users</code>
     * table.
     */
    public Users users() {
        if (_users == null)
            _users = new Users(this, Keys.FK_USER_ROLES_USER);

        return _users;
    }

    /**
     * Get the implicit join path to the <code>airtime_manager.roles</code>
     * table.
     */
    public Roles roles() {
        if (_roles == null)
            _roles = new Roles(this, Keys.FK_USER_ROLES_ROLE);
